...
public final class Constants {
    ...
    // Shoot
    public static final boolean MOTOR_SHOOT_1_INVERTED = false;
    public static final boolean MOTOR_SHOOT_2_INVERTED = true;
    ...
    public static final int SOLENOID_HANG_FORWARD = 0;
    public static final int SOLENOID_HANG_REVERSE = 1;
    ...
    public static final double DISTANCE_METER_PER_ROTATION = 6 * 2.54 / 100.0 * Math.PI; // Wheel Diameter(Inches) * 2.54(inch to cm) / 100.0(cm to meter) * math.PI(Diameter to Wheel Perimeter)
    ...
    public static final double ZERO_ANGLE_MAX_SECONDS = 0;
}
